...
=======================================================
  ...
  CHANGELOG v12.8:
  [NEW] WR Report — detail tiap trade closed:
        • Jam buka & tutup (WIB)
        • Durasi trade (jam & menit)
        • Entry price & estimasi close price
        • Pip profit/loss per trade
...
def main():
    print("=" * 55)
    print("  SMC Multi-Pair Bot  v12.8  [Railway]")
