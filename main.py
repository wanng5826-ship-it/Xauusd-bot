...
=======================================================
  ...
  CHANGELOG v12.9:
  [FIX] 1 pair = 1 sinyal aktif. Selama trade masih open
        di open_trades, pair tersebut dikunci (tidak bisa
        kirim sinyal baru). Sinyal berikutnya baru dikirim
        setelah TP atau SL kena dan trade di-close.
        Solusi untuk USOIL 6× loss berturut-turut.

  CHANGELOG v12.8:
  [NEW] WR Report detail: jam buka/tutup, durasi, entry,
        estimasi close price, pip per trade.

  CHANGELOG v12.7:
  [NEW] WR Report otomatis + command /wr /wr30 /wr1.

  CHANGELOG v12.6:
  [FIX] detect_structure majority voting 3 lookback.
  [FIX] detect_liquidity_sweep zone diperluas.
  [FIX] analyze_pair fallback 1H kalau 4H sideways.
=======================================================
"""
...
def main():
    print("=" * 55)
    print("  SMC Multi-Pair Bot  v12.9  [Railway]")
